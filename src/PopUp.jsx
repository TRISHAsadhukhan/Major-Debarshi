    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-700 bg-opacity-50">
            <div className="bg-white px-10 rounded-lg shadow-md h-60 flex flex-col justify-center">
                ...
                <div>
                    <input type="text" placeholder='Enter Room Key' className={`border py-2 px-4 mt-4 text-lg mr-5 rounded-lg ${borderColor} ${fontColor}`} ref={inputRef} value={value} onChange={(e)=>setValue(e.target.value)}/>

                    <button
                        className="bg-blue-500 hover:bg-orange-600 text-white font-bold py-2 px-4 mt-4 mb-4 text-lg rounded focus:outline-none focus:shadow-outline"
                        onClick={showError}
                    >
                        Join
                    </button>
