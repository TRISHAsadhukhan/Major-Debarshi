                ...
                <div className='h-screen w-3/5 flex flex-col justify-center items-center'>
                    ...
                    <div className='bg-white h-fit w-10/12'>
                        ...
                        <div className='text-7xl h-fit my-5'>
                            <p className='my-3'>Code Collaboration</p>
                            <p>Free For Everyone</p>
                        </div>

                        <div className='text-xl font-normal my-5'>In our collaborative,virtual meeting room, we engage in seamless interactive discussions and efficient remote collaboration</div>
